        ...
        if(data){
            if(!data.error){
                ...
                this.setState({
                    ...
                    layanan: dataProduct.service_name,
                            ...
                            <Grid item xs={12} sm={12} style={{fontSize:'20px', padding:'0px 10px 10px', color:'red', display:'flex', justifyContent:'flex-end'}}>
                                <Grid container style={{display:'flex', justifyContent:'flex-end', padding:'0'}}>
                                    <Grid item xs={2} sm={2} style={{display:'flex', justifyContent:'flex-end'}}>
                                        ...
                                        {
                                           checkPermission('core_product_new') && this.state.modifyType &&
                                            <Tooltip title="Save" style={{outline:'none'}}>
                                                <IconButton aria-label="delete" onClick={this.btnSaveProduct} >
                                                    <SaveIcon />
                                                </IconButton>
                                            </Tooltip>
                                        }

                                        {
                                            ...
                                            <Tooltip title="Edit" style={{outline:'none'}}>
                                                <IconButton aria-label="delete" onClick={this.btnEditProduct}>
                                                    <EditIcon />
                                                </IconButton>
                                            </Tooltip>
                                        }
                                        ...
                                        <Tooltip title="Back" style={{outline:'none'}}>
                                            <IconButton aria-label="delete" onClick={this.btnCancel}>
                                                <CancelIcon />
                                            </IconButton>
                                        </Tooltip>
                                    </Grid>
